...
%CostFunction=@(x)norm(HybridcostMod(x,1e+5));   % Cost Function

xopsw=[   0%0.257283985441709
                   0
  -0.021696575977682
  -0.084791460158090
  -0.015113675183019
...
%CostFunction=@(x)FunCostFull(x,1e+4);   % Cost Function
CostFunction=@(x)FunCostFull([x';xopsw(3:end)],1e+4);   % Cost Function
%-0.050453649329453  -0.020883486063066  -0.016591787867902  -0.090921432393338
%-0.050449253772701 -0.020893169395987 -0.016590831068431 0.259068567677076
%-0.050454882728970  -0.020870977926389  -0.016478474005060   0.259032325877595
%-0.050454902916605  -0.020870281369724  -0.016478468801488   0.259032315075071
