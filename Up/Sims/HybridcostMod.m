function [z,xSt0]=HybridcostMod(x,wrV)
...
%     end
    ...
    [tFlF,xFlF,rFlFfoot] = FlightPhaseOutStride(xStFS,Aznom,l0,phasphi,Lr,gv,I_bod,tpHM0);
    if ((tFlF==tpHM0)||(tFlF<0.001)||(abs(rFlFfoot(3))>1e-4))
        tFlF
        abs(rFlFfoot(3))
...
%     Opt = odeset('AbsTol',1e-10,'RelTol',1e-10);%%,Lr,l0,q5j,dq5j,av
%     if tFlp==0
%         xFl=xStF';
%     else
